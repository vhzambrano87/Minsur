...
{
    public class DTOAguas_operacionesRespuesta
    {
        public DTOAguas_operaciones DTOAguas_operaciones { get; set; }
        public List<DTOAguas_operaciones> DTOListaAguas_operaciones { get; set; }
    }
    public class DTOAguas_operaciones
    {
