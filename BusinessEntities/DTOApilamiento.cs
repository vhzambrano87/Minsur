...
{
    public class DTOApilamientoRespuesta
    {
        public DTOApilamiento DTOApilamiento { get; set; }
        public List<DTOApilamiento> DTOListaApilamiento { get; set; }
    }
    public class DTOApilamiento
    {
